...
包括AstroLib.dll，AtObjExt.dll，AtVGT.dll，AtObjVGT.dll，AstroObj.dll，IAtkObject.dll，ATKComponentJava.dll等，供Java案例脚本加载导入。版本不同，依赖动态库可能有所变动。
...
![依赖文件](media/2-依赖文件/image_zy.png)
