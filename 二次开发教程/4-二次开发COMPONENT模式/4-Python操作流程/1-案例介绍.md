...
- AtkInput/IntegratingWithATK/ATKComponentPythonTest.py，Python案例脚本，建议创建在ATK根目录， 具体内容参考下文案例实现里的代码。包含一个轨道快速转移案例的具体实现过程。该Python案例脚本通过嵌入式Python解释器解释运行，如果脚本包含中文或者目录包含中文，需要先设置文件为UTF-8无BOM编码格式，再编辑案例代码。
