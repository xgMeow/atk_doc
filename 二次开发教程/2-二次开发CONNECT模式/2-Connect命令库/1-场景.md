...
```
SaveAstroMaster <SatellitePath> AstroMaster "<FilePath>"
```

::: note 举例

```
SaveAstroMaster */Satellite/Satellite1 AstroMaster "C:/Users/Desktop/TestPlan.xml"
```
:::

## GetOtherTypeAstroMaster

作用：将卫星机动规划数据输出为JSON格式

用法：

```
GetOtherTypeAstroMaster <SatellitePath> <OutPutType>
```

注意：`<OutPutType>`支持JSON,File格式，JSON
- 说明：

| `<OutPutType>`    |说明                                 |
| ---------------   |------------------------------------ |
| JSON              |将Json格式数据返回给客户端             |
| File              |将数据保存为文件                          |

::: note 举例

```
GetOtherTypeAstroMaster */Satellite/Satellite1 Json
```
::: -->
...
>>>>>>> ef32cc679cc8697b686ef641ece66548c707f43b
## Window2D
