...
# 将 TLE 文件设置为次目标
atkConnect(conID, 'ACAT', '*/AdvCat/AdvCat1 Secondary Add "(ATK根目录)\AtkInput\CAT\TLE20230212.txt" Fixed 10000.0 5000.0 3000.0');
# 设置筛选器参数
...
```atks
#5, 查看报告数据
print(atkConnect(conID, 'Report_RM', '*/AdvCat/AdvCat1 Style "Cat Event Message"'));
```
...
![](./media/17高级接近分析案例/image_17_1.png)
