...
# 添加初始状态段
atkConnect(conID, 'New', '/Satellite/ServiceSatellite/InitialState')
...
atkConnect(conID, 'Astrogator', '*/Satellite/ServiceSatellite SetValue MainSequence.SegmentList.Initial_State.InitialState.Keplerian.M 0')
```
...
```atks
#8, 打印查看报告数据
print(atkConnect(conID, 'Report_RM', '*/Satellite/ServiceSatellite Style "Position" TimePeriod "8 Mar 2007 00:00:00.000" "13 Mar 2007 00:00:00.000"'))
```
