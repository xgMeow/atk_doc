...
# 瞄准段改名
//atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.Target_Sequence.ComponentName ss');
```
...
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.InitialState.InitialState.Keplerian.w 185');
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.InitialState.InitialState.Keplerian.TA 14');
```
...
```atks
#8，第二个预报段
# 第一个预报段后面再加一个预报段（名字默认为Propagate1）
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn InsertSegment MainSequence.SegmentList.TargetSequence.SegmentList.- Propagate');
# 预报段改名
//
## 第二个预报段属性设置（基础属性同上一个预报段）
# 设置中心天体-地球
...
# 设置引力场模型-WGS84
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.Propagate1.ForceModel.Gravity.GravModel WGS84');
# 设置引力场阶数-20
...
# 新建停止条件1-Epoch，2-Periapsis
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.Propagate1.StoppingConditions Epoch Periapsis');
# 设置停止条件1的触发值
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.Propagate1.StoppingConditions.Epoch.TripValue "2028-06-30 02:01:04.184000" UTC')
# 设置停止条件2的中心天体-Earth
...
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.Propagate.Results.AltitudeOfPeriapsis.CentralBody Moon');
...
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.Propagate1.Results.AltitudeOfPeriapsis.CentralBody Earth');
atkConnect(conID, 'Astrogator', '*/Satellite/exLunarFreeReturn SetValue MainSequence.SegmentList.TargetSequence.SegmentList.Propagate1.Results.Inclination.CentralBody Earth');
```
