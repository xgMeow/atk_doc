...
atkConnect(conID, 'Astrogator', '*/Satellite/SatInclinationChange SetValue MainSequence.SegmentList.Initial_State.InitialState.Keplerian.incl 28 deg')
...
atkConnect(conID, 'Astrogator', '*/Satellite/SatInclinationChange SetValue MainSequence.SegmentList.Initial_State.InitialState.Keplerian.argPerigee 0 deg')
atkConnect(conID, 'Astrogator', '*/Satellite/SatInclinationChange SetValue MainSequence.SegmentList.Initial_State.InitialState.Keplerian.trueAnomaly 0 deg')
# 设置轨道历元
...
``` atk
#18, 查看报告数据
print(atkConnect(conID, 'Report_RM', '*/Satellite/SatInclinationChange Style "Position" TimePeriod "5 Nov 2022 00:00:00.000" "8 Nov 2022 00:00:00.000"'))
```
