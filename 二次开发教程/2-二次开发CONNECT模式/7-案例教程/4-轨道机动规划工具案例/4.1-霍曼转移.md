...
atkConnect(conID, 'Astrogator', '*/Satellite/HohmannTransfer SetValue MainSequence.SegmentList.Propagate.ForceModel.ThirdBodies.CentralBodyName.UseGravity 9');
atkConnect(conID, 'Astrogator', '*/Satellite/HohmannTransfer SetValue MainSequence.SegmentList.Propagate.ForceModel.ThirdBodies.CentralBodyName.UseGravity 10');
...
atkConnect(conID, 'Astrogator', '*/Satellite/HohmannTransfer SetValue MainSequence.SegmentList.Propagate1.ForceModel.ThirdBodies.CentralBodyName.UseGravity 9');
atkConnect(conID, 'Astrogator', '*/Satellite/HohmannTransfer SetValue MainSequence.SegmentList.Propagate1.ForceModel.ThirdBodies.CentralBodyName.UseGravity 10');
...
atkConnect(conID, 'Astrogator', '*/Satellite/HohmannTransfer SetValue MainSequence.SegmentList.Propagate2.ForceModel.ThirdBodies.CentralBodyName.UseGravity 9');
atkConnect(conID, 'Astrogator', '*/Satellite/HohmannTransfer SetValue MainSequence.SegmentList.Propagate2.ForceModel.ThirdBodies.CentralBodyName.UseGravity 10');
...
```atks
#12, 查看报告数据
print(atkConnect(conID, 'Report_RM', '*/Satellite/HohmannTransfer Style "Position" TimePeriod "5 Nov 2022 00:00:00.000" "7 Nov 2022 00:00:00.000"'))
```
...
![](./media/4.1霍曼转移/image1.png)

报告数据结果如下图所示：

![](./media/4.1霍曼转移/image2.png)
