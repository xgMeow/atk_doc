...
import { offlineBundler } from './bundler-offline/index.js'
import path from "path"
import viteBundler from "@vuepress/bundler-vite";

export const useConfig = ({offline}) => defineUserConfig({
  base: "/",
  lang: "zh-CN",
  title: offline?"ATK 帮助文档(离线版)": "ATK 帮助文档",
...
export default useConfig({offline:false});