export default {
    ...
    config:{ 
        ...
        // ATK对象
        "/topics/Objects/Satellite/index":                    "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html",     //卫星-属性；右下角的“help”按钮 
        "/topics/Objects/Satellite/Orbit":                    "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#轨道",          //卫星-属性-点击轨道后；右下角的“help”按钮 
        "/topics/Objects/Satellite/Attitude":                 "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#姿态",          //卫星-属性-点击姿态后；右下角的“help”按钮 
        "/topics/Objects/Satellite/Mass":                     "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#质量",          //卫星-属性-点击质量后；右下角的“help”按钮 
        "/topics/Objects/Satellite/PassBreak":                "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#轨道圈数",       //卫星-属性-点击轨道圈数后；右下角的“help”按钮 
        "/topics/Objects/Satellite/2DGraphics":               "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#二维视图",          //卫星-属性-点击二维视图及其下属后；右下角的“help”按钮 
        "/topics/Objects/Satellite/3DGraphics":               "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#三维视图",          //卫星-属性-点击三维视图及其下属后；右下角的“help”按钮 
        "/topics/Objects/Satellite/Constraints":              "/4.基础使用指南/2-插入对象/10-对象属性/卫星.html#约束",             //卫星-属性-点击约束后；右下角的“help”按钮 
        ...
        "/topics/Objects/Facility":                           "/4.基础使用指南/2-插入对象/10-对象属性/地面站.html",      //地面站-属性；右下角的“help”按钮 
        "/topics/Objects/Sensor":                             "/4.基础使用指南/2-插入对象/10-对象属性/传感器.html",      //传感器-属性；右下角的“help”按钮 
        "/topics/Objects/Receiver":                           "/4.基础使用指南/2-插入对象/10-对象属性/接收器.html",      //接收器-属性；右下角的“help”按钮 
        "/topics/Objects/Transmitter":                        "/4.基础使用指南/2-插入对象/10-对象属性/发射器.html",      //发射器-属性；右下角的“help”按钮 
        "/topics/Objects/SatelliteCollection":                "/4.基础使用指南/2-插入对象/10-对象属性/卫星集群.html",             //卫星集群-属性：右下角的“help”按钮 
        ...
        "/topics/Attitude/AttitudeFixedInCBI":                "/4.基础使用指南/姿态定义/3-固定于天体惯性系姿态.html",
        "/topics/Attitude/AttitudeAlignedConstrained":        "/4.基础使用指南/姿态定义/4-对齐约束姿态.html",
        "/topics/Attitude/AttitudeMutilSegment":              "/4.基础使用指南/姿态定义/5-多分段姿态.html",
        "/topics/Attitude/AttitudeRealTime":                  "/4.基础使用指南/姿态定义/6-实时姿态.html",
        "/topics/Attitude/AttitudeSTKAttitude":               "/4.基础使用指南/姿态定义/7-STK文件姿态.html",
        "/topics/Attitude/AttitudeSpinning":                  "/4.基础使用指南/姿态定义/9-旋转姿态.html",
        "/topics/Attitude/AttitudeTargetPointing":            "/4.基础使用指南/姿态定义/10-目标指向姿态.html",
        "/topics/Attitude/AttitudeVVLHCBI":                   "/4.基础使用指南/姿态定义/12-惯性系VVLH姿态.html",
        "/topics/Attitude/AttitudeVVLHCBF":                   "/4.基础使用指南/姿态定义/13-固连系VVLH姿态.html",
        "/topics/Attitude/AttitudeEcfAligndVel":              "/4.基础使用指南/姿态定义/15-ECF对速度定向.html",
        "/topics/Attitude/AttitudeEciAligndVel":              "/4.基础使用指南/姿态定义/16-ECI对速度定向.html"
    }
}