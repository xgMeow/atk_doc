export default {
    ...
    config:{ 
        ...
        // ATK对象
        "/topics/Objects/Satellite/index":                    "/4.基础使用指南/4.2创建对象.html#卫星的属性设置",     //卫星-属性；右下角的“help”按钮 
        ...
        "/topics/Attitude/AttitudeEcfAligndVel":                "/4.基础使用指南/7-基础模型/2-姿态定义/15-ECF对速度定向.md",
        "/topics/Attitude/AttitudeEciAligndVel":                "/4.基础使用指南/7-基础模型/2-姿态定义/16-ECI对速度定向.md"
    }
}